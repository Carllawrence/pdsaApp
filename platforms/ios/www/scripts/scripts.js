"use strict"; angular.module("yapp", ["ui.router", "snap", "ngAnimate", 'chart.js'])
...
angular.module("yapp")
.controller("DashboardCtrl", ["$scope", "$state","$http","$rootScope", function (r, t, h, rs) { 
  ...
  var app = {
    ...
    scan: function() {
        ...
        scanner.scan( function (result) { 
            ...
            h.get('https://access.strivetogether.org/api/tutors/' + result.text).then(function(response){
                console.log(response.data.data);

                r.tutordata = response.data.data;
        });
